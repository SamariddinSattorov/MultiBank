...
public class Ipoteka_KREDIT extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ipoteka_kredit);


        findViewById(R.id.ipoteka_omonat_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                clicked_btn("https://data.gov.uz/uz/sphere/5");
            }
        });
        ...
        findViewById(R.id.btf_ipoteka_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                clicked_btn("https://depozit.uz/credits/view/60104");
            }
        });
